...
from adopcion.forms import PersonaForm, SolicitudForm,FechasForm


def ver_fechas(request):
    
    return render (request,"adopcion/fechas.html",{})
...
def fechas(request):
	form = FechasForm(request.POST or None)
	if form.is_valid():
	...
	return render (request,"adopcion/fecha.html",context)
