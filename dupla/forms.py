...
class derivacionduplaForm(forms.ModelForm):
	...
	class Meta:
		...
		labels = {
			...
			'quien_deriva':'Persona que realiza la derivación ejemplo: Profesor jefe / Adulto responsable ( Apoderado )',
			'profe_jefe':'Profesor jefe (Si es la misma persona quien deriva ingresar dos veces) ',
			'conducta':'¿La conducta identificada, afecta el proceso de enseñanza-aprendizaje del estudiante? (En el caso que la derivación sea a petición del adulto responsable, registrar la información proveniente de dicha persona o ingresar "Demanda de adulto responsable")',
			'afecta':'¿Como afecta? (En el caso que la derivación sea a petición del adulto responsable, registrar la información proveniente de dicha persona o ingresar "Demanda de adulto responsable")',
			'reiterada':'¿Desde cuando se reitera la conducta?(En el caso que la derivación sea a petición del adulto responsable, registrar la información proveniente de dicha persona o ingresar "Demanda de adulto responsable")',
			'marzo':'Inasistencia mes de marzo - Sino cuenta con dicha información ingresar 0',
			'abril':'Inasistencia mes de abril',
			'mayo':'Inasistencia mes de mayo - Sino cuenta con dicha información ingresar 0',
			'junio':'Inasistencia mes de junio - Sino cuenta con dicha información ingresar 0',
			'julio':'Inasistencia mes de julio - Sino cuenta con dicha información ingresar 0',
			'agosto':'Inasistencia mes de agosto - Sino cuenta con dicha información ingresar 0',
			'septiembre':'Inasistencia mes de septiembre - Sino cuenta con dicha información ingresar 0',
			'octubre':'Inasistencia mes de octubre - Sino cuenta con dicha información ingresar 0',
			'noviembre':'Inasistencia mes de noviembre - Sino cuenta con dicha información ingresar 0',
			'diciembre':'Inasistencia mes de diciembre - Sino cuenta con dicha información ingresar 0',
			'observacion':'Entrevista con el profesor que deriva (Observaciones generales / Observaciones generales del adulto responsable)',
